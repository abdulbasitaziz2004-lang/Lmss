...
const Navbar = () => {
    ...
    <div className="max-w-[1400px] -mr-3 px-12 flex justify-around items-center">
          ...
          <nav>
            <ul className="flex gap-12 list-none max-lg:hidden">
              ...
              <li><Link href="#community" className="text-[#a1a1aa] no-underline font-medium text-[0.95rem] hover:text-white transition-colors duration-300 relative after:content-[''] after:absolute after:bottom-[-5px] after:left-0 after:w-0 after:h-0.5 after:bg-linear-to-r after:from-blue-500 after:to-purple-500 after:transition-all after:duration-300 hover:after:w-full">Community</Link></li>
            </ul>
          </nav>
  ...
  <SignedIn>
    <UserButton
      appearance={{
        elements: {
          userButtonBox: "p-2 rounded-xl border border-[rgba(255,255,255,0.1)] bg-transparent hover:bg-[rgba(255,255,255,0.05)]",
        },
      }}
    />
  </SignedIn>
<a
    href="#"
    className="py-[0.7rem] px-[1.8rem] border-none rounded-xl cursor-pointer font-semibold text-[0.9rem] transition-all duration-300 no-underline inline-block bg-linear-to-r from-blue-500 to-purple-500 text-white shadow-[0_4px_15px_rgba(59,130,246,0.3)] hover:-translate-y-0.5 hover:shadow-[0_6px_25px_rgba(59,130,246,0.4)]" >
    Get Started
  </a>
</div>
{/* dark mode button */}
